...
export default function Section5(){
    return(
        <div className="w-full h-screen flex justify-center flex-col items-center px-5" id="contact">
            ...
            <div className="w-11/12 sm:w-3/4 md:w-2/3 lg:w-1/2 xl:w-2/5 2xl:w-2/6 h-24 border-2 border-gray-400 rounded-3xl flex justify-center items-center flex-row">
                <div className="w-3/5 h-full flex justify-center items-center flex-row gap-2 sm:gap-3">
                ...
                <div className="w-2/5 h-full flex justify-center items-center flex-row gap-2 sm:gap-3">
